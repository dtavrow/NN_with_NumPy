...
Contents:
- NN_with_NumPy.ipynb: full implementation of the neural network and experiments
- NN_test_data.npy: dataset containing time-series signals used to validate implementation
